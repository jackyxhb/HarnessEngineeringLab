# Core Features for MAS - Multi-Agent Systems
...
- **P1-9. Branch-Based Cognitive Memory:** Decomposing complex tasks into independent sub-task branches for parallel agents, relying on merge gates and detailed commit histories for transparent structural memory.
