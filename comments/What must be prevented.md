...
Here is a breakdown of what must be prevented across the four core areas of harness engineering:

## 1. Prevent Context and Memory Degradation
...
## 2. Prevent Coordination and Execution Failures
...
## 3. Prevent Security, Ethics, and Emergent Risks
...
* **Prevent Opaque Decision-Making:** You must prevent decentralized unaccountability, where it is impossible to know *which* agent made a harmful decision. Prevent this by enforcing strict audit trails that log every tool call, state transition, and inter-agent influence.
...
## 4. Prevent Lifecycle and Architectural Decay
