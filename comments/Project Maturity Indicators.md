...
* **Foundation - Foundational Infrastructure (Verify & Correct):** The harness provides the execution engine: secure bash sandboxes, filesystem & Git workspace, self-verification loops, Ralph Loops for long-horizon tasks, orchestration logic, escalation policies, rippable middleware, and harness versioning. This is the prerequisite layer that all pillars build upon.
