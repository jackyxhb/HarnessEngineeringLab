...
Here is how harness engineering directly enables and manages multi-agent working mechanisms:

### 1. The Filesystem as a Shared Collaboration Surface
...
### 2. Orchestration Logic and Coordination Topologies
...
### 3. AI Auditors as Architectural Constraints
...
### 4. Entropy Management Across Agent Teams
...
### 5. Context Compaction and Bounded Autonomy

Multi-agent systems significantly expand the attack surface; one hallucinating or compromised agent can corrupt the shared state or derail downstream peer decisions. The harness mitigates this through context engineering and security boundaries:
