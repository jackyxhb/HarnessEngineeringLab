...
```markdown
Perform a gap analysis on the project's Foundation features (P0-1 through P0-9, plus P0-MAS if multi-agent).
...
<scratchpad>
For each feature (P0-1 through P0-9):
...
```markdown
Perform a gap analysis on Pillar 1: Context Engineering (P1-1 through P1-10).
...
<scratchpad>
For each feature (P1-1 through P1-10):
1. Check "What to Do" — does the target project implement this?
2. Check "Don't Do" — is the prevention failure currently active?
3. Check "Options" — which actions/tools should be recommended?
Map findings to files you actually read.
