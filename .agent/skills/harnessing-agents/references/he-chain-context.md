...
Each feature follows the assessment chain: **What to Do** (definition) → **Don’t Do** (prevention) → **Options** (actions & tools). Each section is annotated with its chain level (L2–L5) per `framework/HE Principle Practice Chain.md`. Use this chain to assess a target project and recommend concrete improvements.

---

## P1-1. Repository as Truth [EP-11]
...
## P1-2. Context Compaction & Memory Management [EP-12]
...
## P1-5. Observability / Dashboards [EP-8]
...
## P1-6. Web Search & MCP Integration [EP-13]
...
## P1-7. Planning, Task Lists & Blackboards [EP-2]
...
## P1-9. Branch-Based Cognitive Memory [EP-2]
...
## P1-10. Requirements Ledger [EP-11]
...
## P1-11. Socratic Questioning [EP-14]
