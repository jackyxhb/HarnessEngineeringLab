...
check_file "framework/HE Measurement Standards.md"     "Measurement standards contract"
...
check_file ".harness/prevention-rules-registry.json" "Prevention rules registry"
check_file ".harness/prevention-enforcement-config.json" "Prevention enforcement config"
check_file ".harness/measurement-schema.json"        "Measurement schema"
check_file ".harness/measurement-definitions.json"   "Measurement definitions registry"
...
validate_json_file ".harness/prevention-rules-registry.json" "Prevention rules registry"
validate_json_file ".harness/prevention-enforcement-config.json" "Prevention enforcement config"
validate_json_file ".harness/measurement-schema.json" "Measurement schema"
validate_json_file ".harness/measurement-definitions.json" "Measurement definitions registry"
